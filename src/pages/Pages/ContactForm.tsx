...
const ContactForm = () => {
    ...
    return (
        <>
            <ul className="absolute m-24 flex space-x-2 rtl:space-x-reverse">
                <li>
            ...
            >
                <div className="panel sm:w-[480px] m-6 max-w-lg w-full">
                    ...
                    <p className="mb-7">Dejanos tu mensaje, y nos comunicaremos lo antes posible.</p>
                    <form className="space-y-4" onSubmit={submitForm}>
                        <div className="relative">
                            ...
                            <input type="text" className="form-input ltr:pl-8 rtl:pr-8" placeholder="Nombre" />
                        </div>
                        <div className="relative">
                            <span className="absolute ltr:left-2 rtl:right-2 top-2.5 text-primary">
                        ...
                        <div className="relative">
                            ...
                            <input type="text" className="form-input ltr:pl-8 rtl:pr-8" placeholder="Teléfono" />
                        </div>
                        <div className="relative">
                            <span className="absolute ltr:left-2 rtl:right-2 top-2.5 text-primary">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-5 h-5">
                            ...
                            <input type="text" className="form-input ltr:pl-8 rtl:pr-8" placeholder="Motivo" />
                        </div>
                        <div className="relative">
                            <span className="absolute ltr:left-2 rtl:right-2 top-2.5 text-primary">
                                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <textarea rows={4} className="form-textarea ltr:pl-8 rtl:pr-8 resize-none" placeholder="Mensaje"></textarea>
                        </div>
